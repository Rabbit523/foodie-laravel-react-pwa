                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ route('restaurant.disableCategory', $itemCategory->id) }}" class="badge badge-primary badge-icon ml-1" data-popup="tooltip" title="Disable Category" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                @else
                                <a href="{{ route('restaurant.disableCategory', $itemCategory->id) }}" class="badge badge-danger badge-icon ml-1" data-popup="tooltip" title="Enable Category" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
